classdef circuit < base & event.source
    ...
    methods
        ...
        function solve(this)
            ...
            this.throw('circuit','The AC electrical solver is not yet implemented.');
            
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%% The following code is just a copy of the DC solver at some
            %%% point in time. It is here fore reference, but obviosly
            %%% needs to be heavily modified to be used for AC circuits.
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%s
