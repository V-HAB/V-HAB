classdef logger_basic < simulation.monitor
    ...
    properties (GetAccess = public, Constant = true)
        ...
        poUnitsToLabels = containers.Map(...
            { 's',    'kg',   'kg/s',      'g/s',       'K',           '°C',          'Pa',       'J/K',                 'J/kgK',                  'W/K',          'W',     'F',        'Ohm',        'H',           'A',       'V',       'C',      'mol/kg',        'ppm',           '%',       'Ah',     '-',    'kg/m^3',   'm/s'}, ...
            { 'Time', 'Mass', 'Flow Rate', 'Flow Rate', 'Temperature', 'Temperature', 'Pressure', 'Total Heat Capacity', 'Specific Heat Capacity', 'Conductivity', 'Power', 'Capacity', 'Resistance', 'Inductivity', 'Current', 'Voltage', 'Charge', 'Concentration', 'Concentration', 'Percent', 'Charge', '',     'Density',   'Velocity'} ...
        );
    end
