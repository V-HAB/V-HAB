classdef logger_basic < simulation.monitor
    ...
    properties (GetAccess = public, Constant = true)
        ...
        poExpressionToUnit = containers.Map(...
            { 'this.fMass * this.fMassToPressure', 'fMassToPressure', 'fMass', 'afMass', 'fFlowRate', 'fTemperature', 'fPressure', 'afPP', 'fTotalHeatCapacity', 'fSpecificHeatCapacity', 'fConductivity' }, ...
            { 'Pa',                                'Pa/kg',           'kg',    'kg',     'kg/s',      'K',            'Pa',        'Pa',   'J/K',                'J/kgK',                 'W/K'           }  ...
        );
        
        poUnitsToLabels = containers.Map(...
            { 'kg',   'kg/s',      'K',           'Pa',       'J/K',                 'J/kgK',                  'W/K',          '-'}, ...
            { 'Mass', 'Flow Rate', 'Temperature', 'Pressure', 'Total Heat Capacity', 'Specific Heat Capacity', 'Conductivity', '' } ...
        );
    end
