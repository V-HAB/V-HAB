classdef table < base
    ...
    properties (SetAccess = protected, GetAccess = public)
        ...
        ttxMatter = struct ( ...
            ...
            'Brine', struct ( ...
            ...
            ... concentrated Brine from Urine; solid or soluted in liquid phase
            ... Simplification: Brine only consists of Urea, as with 36% of the total 
            ... contaminants mass Urea is the most important amongst 
            ... all contaminants in human urine
            ...
                'fMolMass', 60.06, ...
                'ttxPhases', struct( ...
                    'solid', struct(...
                        'fCp', 1497, ...     % at 293.15 K (4.1147*T+291.07)
                        'fDensity', 1355 ... % at 293.15 K (1396-0.208*T)
                        ), ...
                    'liquid', struct(... 
                        'fCp', 1500, ...     % at 293.15 K and X_Urea=1 (4200-2700*X_Urea); X_Urea: mass fraction of phase
                        'fDensity', 1278 ... % at 293.15 K and X_Urea=1 (1144.5+280*X_Urea-0.5*T)
                        ), ...
                     'gas', struct(...      % Urea decomposes in the gas phase into NH3 and HNCO (at high temperatures)
                        'fCp', 45.03, ...     % at 298.15 K                                       --------!!! values not correct yet!  
                        'fDensity', 1140 ... % at 293.15 K and X_Urea=1 (1144.5+280*X_Urea-0.5*T) --------!!! values not correct yet!
                        ) ...   
                    )...
            ), ...
            'CH4', struct ( ...
    ...
    properties (Constant = true, GetAccess = public)
        ...
        % Where ist this number from? Always give a source! 
        % Wikipedia says 8.3144621 J/molK
        C = struct( ...
            'R_m', 8.314472 ... % J/molK
        );
    end
