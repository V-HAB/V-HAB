...
% Only do this if the compound mass with this name does not yet exist
if ~isfield(this.tiN2I, sCompoundName)
    ...
    this.afMolarMass(this.tiN2I.(sCompoundName)) = sum(this.afMolarMass .* arBaseComposition);
