...
L_gas = 17.9832;        % [m] (215 in) length of gas channel from solid model
L_liquid = 0.0315;      % [m] (21 x 10" flow channels)
...
%% IL properties
v_d = 406;              % Dyn. Visc. of IL [406 mPa-s] @ 303 K, (Yates/Space 2016 paper)
p = 1.0538;             % Density of IL [1.0538 g cm^-3] @ 303 K, (Bogolitsyn 2008)
v = (v_d/p)*(1e-6);     % Kin. Visc. [m^2/s] *equation standard*
D = 7.52398e-11;        % Diffusivity of CO2 in IL  [m^2/s] *equation standard* (Santos 2014)
