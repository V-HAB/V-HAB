classdef setup < simulation.infrastructure
    ...
    methods
        ...
        function this = setup(varargin) 
            ...
            this@simulation.infrastructure('Example_HeatOfExpansion', containers.Map(), struct(), struct());
            
            % Creating the 'Example' system as a child of the root system
            % of this simulation. 
            examples.HeatOfExpansion.systems.Example(this.oSimulationContainer, 'Example');
        ...
        function configureMonitors(this)
            ...
            oLogger.addValue('Example:s:Tank_1.aoPhases(1).oCapacity.toHeatSources.JouleThomsonSource_1', 'fHeatFlow', 'W', 'Joule Thomson Heat Flow Phase 1');
            oLogger.addValue('Example:s:Tank_2.aoPhases(1).oCapacity.toHeatSources.JouleThomsonSource_2', 'fHeatFlow', 'W', 'Joule Thomson Heat Flow Phase 2');
            oLogger.addValue('Example.toBranches.Branch.aoFlowProcs(1)', 'fHeatFlow', 'W', 'Joule Thomson Heat Flow Pipe');
        ...
        function plot(this) 
            ...
            coPlots{2,2} = oPlotter.definePlot({'"Joule Thomson Heat Flow Phase 1"', '"Joule Thomson Heat Flow Phase 2"', '"Joule Thomson Heat Flow Pipe"'}, 'Heat Flows');
