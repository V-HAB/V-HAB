classdef compressor < matter.procs.f2f
    ...
    methods
        function this = compressor(oContainer, sName, fSpeedSetpoint, sDirection,oPhase_in,oPhase_out,fPressure_in, tCharacteristic)
            % Constructor
            % Required inputs:
        ...
        function fDeltaPressure = solverDeltas(this, fFlowRate)
            ...
            %new try-----------------------------------------------
            K=0.002;
            this.fSpeedSetpoint=(this.oPhase_in.fPressure-this.fPressure_in)*K;
            
            if this.fSpeedSetpoint<0
                this.fSpeedSetpoint=0;
            end
