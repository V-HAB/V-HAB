classdef Example < vsys
    ...
    methods
        ...
        function createMatterStructure(this)
            ...
            % operated
            mfUrineConcentrations = [1];%[3.5, 7, 20, 40, 60, 80, 100] ./ 100;
            % Series:['C' 'H' 'I' 'D' 'E' 'F']
            ...
            % Urine concentrations see MA Schalz Table 3-2
            ...
            for iUrineConcentration = 1:length(mfUrineConcentrations)
                ...
                oUrinePhase = matter.phases.mixture(oStore, 'Urine', 'liquid', struct('H2O',    fWaterMass,...
                                                                                      'CH4N2O', tfConcentration.CH4N2O   * 1000 * fVolume * afMolMass(tiN2I.CH4N2O),...
                                                                                      'NH3',    tfConcentration.NH3      * 1000 * fVolume * afMolMass(tiN2I.NH3),...
                                                                                      'NH4',    tfConcentration.NH4      * 1000 * fVolume * afMolMass(tiN2I.NH4),...
                                                                                      'NO2',    tfConcentration.NO2      * 1000 * fVolume * afMolMass(tiN2I.NO2),...
                                                                                      'NO3',    tfConcentration.NO3      * 1000 * fVolume * afMolMass(tiN2I.NO3),...
                                                                                      'Ca2plus',tfConcentration.Ca       * 1000 * fVolume * afMolMass(tiN2I.Ca),...
                                                                                      'Clminus',tfConcentration.Cl       * 1000 * fVolume * afMolMass(tiN2I.Cl),...
                                                                                      'C6H5O7', tfConcentration.C6H5O7   * 1000 * fVolume * afMolMass(tiN2I.C6H5O7),...
                                                                                      'Naplus', tfConcentration.Na       * 1000 * fVolume * afMolMass(tiN2I.Na),...
                                                                                      'SO4',    tfConcentration.SO4      * 1000 * fVolume * afMolMass(tiN2I.SO4),...
                                                                                      'HPO4',   tfConcentration.HPO4     * 1000 * fVolume * afMolMass(tiN2I.HPO4),...
                                                                                      'Kplus',  tfConcentration.K        * 1000 * fVolume * afMolMass(tiN2I.K),...
                                                                                      'Mg2plus',tfConcentration.Mg       * 1000 * fVolume * afMolMass(tiN2I.Mg))...
                                                                                      , 295, 101325); 
