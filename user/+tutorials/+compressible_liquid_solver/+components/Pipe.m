...
classdef Pipe < solver.matter.linear.procs.f2f
    ...
    methods
        ...
        function update(this)
            ...
            if bZeroFlows == 0
                ...
                this.fDeltaPressure = pressure_loss_pipe (this.fHydrDiam, this.fHydrLength,...
                                fFlowSpeed, 1200.4*10^-6, fDensity, this.fRoughness, 1);
            end
        ...
        function [ fDeltaPress, fDeltaTemp ] = solverDeltas(this, fFlowRate)
            ...
            fRoh = (fP * oFlowIn.fMolMass / 1000) / (matter.table.C.R_m * oFlowIn.fTemp);
