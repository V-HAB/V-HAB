classdef setup < simulation.infrastructure
    ...
    methods
        function this = setup(ptConfigParams, tSolverParams) % Constructor function
            ...
            this@simulation.infrastructure('Tutorial_Equalizer', ptConfigParams, tSolverParams, ttMonitorConfig);
            
            % Creating the 'Example' system as a child of the root system
            % of this simulation. 
            tutorials.equalizer.systems.Example(this.oSimulationContainer, 'Example');
