classdef ExampleSubsystem < vsys
    ...
    methods
        ...
        function createMatterStructure(this)
            ...
            tutorials.reconnectingExMe.components.Filter(this, 'Filter', 10);
            ...
            matter.branch(this, 'Filter.FilterIn', {}, 'Inlet', 'Filter_Inlet');
            
            % Creating the branch out of this subsystem into the parent system 
            % Input parameter format is always: 
            % 'store.exme', {'f2f-processor, 'f2fprocessor'}, 'Interface port name'
            matter.branch(this, 'Filter.FilterOut', {}, 'Outlet', 'Filter_Outlet');
