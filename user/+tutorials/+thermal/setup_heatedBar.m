classdef setup_heatedBar < simulation
    ...
    methods
        ...
        function this = setup_heatedBar()
            % Create a new simulation with the system described in
            % Example_heatedBar. 
            
            % Initialize simulation with name. 
            this@simulation('TestCase_heatedBar');
            
            % Create system Example_heatedBar. 
            oThermalSystem = tutorials.thermal.systems.example_heatedBar(this.oRoot, 'heatedBar');
            ...
            % converge.
            this.oTimer.bind(@(o) this.breakAtConvergence(o), 1);
        ...
        function breakAtConvergence(this, oTimer)
            ...
            mNodeTemperatures = this.oRoot.toChildren.heatedBar.getNodeTemperatures();
