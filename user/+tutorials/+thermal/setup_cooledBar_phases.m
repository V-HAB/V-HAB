...
%             };
        ...
        function updateThermalProperties(this)
            ...
            poLinC('linear:Bar__Block1+Bar__Block2').setConductivity( ...
                hCalcFunc(oTSys.calcAlLambda(mMeanTemps(1)), 0.0016, 0.05) ...
            );
            poLinC('linear:Bar__Block2+Bar__Block3').setConductivity( ...
                hCalcFunc(oTSys.calcAlLambda(mMeanTemps(2)), 0.0016, 0.05) ...
            );
            poLinC('linear:Bar__Block3+Bar__Block4').setConductivity( ...
                hCalcFunc(oTSys.calcAlLambda(mMeanTemps(3)), 0.0016, 0.05) ...
            );
            poLinC('linear:Bar__Block4+Bar__Block5').setConductivity( ...
