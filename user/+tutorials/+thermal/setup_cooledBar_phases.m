classdef setup_cooledBar_phases < simulation
    ...
    methods
        ...
        function this = setup_cooledBar_phases()
            % Create a new simulation with the system described in
            % Example_cooledBar_phases. 
            
            % Initialize simulation with name. 
            this@simulation('TestCase_cooledBar_phases', 5e-3);
            
            % Create system Example_cooledBar. 
            oThermalSystem = tutorials.thermal.systems.example_cooledBar_phases(this.oRoot, 'cooledBar');
