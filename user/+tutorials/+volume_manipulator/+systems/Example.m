classdef Example < vsys
    ...
    methods
        ...
        function createMatterStructure(this)
            ...
            % add the volume manipulator to this phase
            tutorials.volume_manipulator.components.volumeChanger('Compressor', oGasPhase);
            ...
            oAirPhase = this.toStores.Tank_2.createPhase('air', 1, 323.15, 0.5, 1e5);
