classdef Incompressible_System_Definition < simulation
    ...
    methods
        function this = Incompressible_System_Definition()
            ...
            oIncompressible_System.oSystemSolver = solver.matter.incompressible_liquid.system_incompressible_liquid(oIncompressible_System, 1e-3, 5, 1e-2, 500, iIncompBranches, 10, mLoopBranches);
