classdef setup < simulation
    ...
    methods
        function this = setup() % Constructor function
            this@simulation('PlantModuleExample');
            
            % Creating the root object
            oExample = tutorials.plant_module.systems.PlantModuleExample(this.oRoot, 'PlantModuleExample');
            ...
            %             aoPhases = this.oRoot.toChildren.PlantModuleExample.toChildren.SubSystemColdplate.toStores.water_absorber.aoPhases;
            %             aoPhases(1).bSynced = true;
            %              aoPhases = this.oRoot.toChildren.PlantModuleExample.toStores.PotableWaterTank.aoPhases;
            %              aoPhases(1).fFixedTS = 0.5;
            %              aoPhases = this.oRoot.toChildren.PlantModuleExample.toStores.crew_module.aoPhases;
            %              aoPhases(1).fFixedTS = 0.5;
            ...
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).fPressure'; % crew module
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).fMass';
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).rRelHumidity';
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).afPP(11)';
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).afPP(7)';
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).afMass(11)';
            'toChildren.PlantModuleExample.toStores.crew_module.aoPhases(1).afMass(7)';
            'toChildren.PlantModuleExample.toStores.PotableWaterTank.aoPhases(1).fMass'; % potable water tank
            'toChildren.PlantModuleExample.toStores.PotableWaterTank.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.Food_Storage.aoPhases(1).fMass'; % Food Storage
            'toChildren.PlantModuleExample.toStores.Food_Storage.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.Inedible_Biomass.aoPhases(1).fMass'; % Inedible Biomass
            'toChildren.PlantModuleExample.toStores.Inedible_Biomass.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.N2_buffer_tank.aoPhases(1).fPressure';% N2 buffer tank
            'toChildren.PlantModuleExample.toStores.N2_buffer_tank.aoPhases(1).fMass';
            'toChildren.PlantModuleExample.toStores.N2_buffer_tank.aoPhases(1).rRelHumidity';
            'toChildren.PlantModuleExample.toStores.N2_buffer_tank.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.NutrientTank.aoPhases(1).fMass'; % NutrientTank
            'toChildren.PlantModuleExample.toStores.NutrientTank.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.InedibleBiomassH2O.aoPhases(1).fMass'; % InedibleBiomassH2O
            'toChildren.PlantModuleExample.toStores.InedibleBiomassH2O.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.InedibleBiomassH2O.aoPhases(1).afMass(18)';
            'toChildren.PlantModuleExample.toStores.InedibleBiomassH2O.aoPhases(1).afMass(10)';
            'toChildren.PlantModuleExample.toStores.HygieneWaterTank.aoPhases(1).fMass'; % HygieneWaterTank
            'toChildren.PlantModuleExample.toStores.HygieneWaterTank.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.H2O2Tank.aoPhases(1).fMass'; % H2O2Tank
            'toChildren.PlantModuleExample.toStores.H2O2Tank.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toStores.Deadlock.aoPhases(1).fMass'; % Deadlock
            'toChildren.PlantModuleExample.toStores.Deadlock.aoPhases(1).fTemp';
            'toChildren.PlantModuleExample.toChildren.PlantModule.toStores.PlantCultivationStore.aoPhases(1).fMass';% algae modul log
            'toChildren.PlantModuleExample.toChildren.PlantModule.toStores.PlantCultivationStore.aoPhases(2).fMass';
            'toChildren.PlantModuleExample.toChildren.PlantModule.aoBranches(1).fFlowRate';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.internaltime';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.TCB';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.internalGeneration';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.TEB';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.O2_exchange';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.CO2_exchange';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.water_exchange';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.CUE_24';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.AddGen';
            'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Manip.fCCulture.plants{73, 1}.state.A';
%             'toChildren.PlantModuleExample.toChildren.PlantModule.aoBranches(2).fFlowRate';
%             'toChildren.PlantModuleExample.toChildren.PlantModule.aoBranches(3).fFlowRate';
%             'toChildren.PlantModuleExample.toChildren.PlantModule.aoBranches(4).fFlowRate';
%             'toChildren.PlantModuleExample.toChildren.PlantModule.aoBranches(5).fFlowRate';
%             'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Absorber_Algae.fFlowRate';% Flowphase -> Algae
%             'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Absorber_Algae2.fFlowRate'; %CO2
%             'toChildren.PlantModuleExample.toChildren.PlantModule.oProc_Absorber_O2.fFlowRate';%O2
            'toChildren.PlantModuleExample.toChildren.PlantModule.toStores.PlantCultivationStore.aoPhases(2).afMass(7)';%O2
            'toChildren.PlantModuleExample.toChildren.PlantModule.toStores.PlantCultivationStore.aoPhases(2).afMass(11)';%CO2
            'toChildren.PlantModuleExample.toChildren.PlantModule.toStores.PlantCultivationStore.aoPhases(2).afMass(13)';%NO3
            'toChildren.PlantModuleExample.toChildren.PlantModule.toStores.PlantCultivationStore.aoPhases(2).afMass(16)';%Spirulina

            %             'toChildren.PlantModuleExample.toChildren.PlantModule.toChildren.TemperatureControl_and_Illumination.fP_harv';
            %             'toChildren.PlantModuleExample.toChildren.PlantModule.toChildren.TemperatureControl_and_Illumination.fP_fill';
            %             'toChildren.PlantModuleExample.toChildren.PlantModule.toChildren.TemperatureControl_and_Illumination.fQ_out';
