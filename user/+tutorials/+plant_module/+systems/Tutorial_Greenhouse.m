classdef Tutorial_Greenhouse < vsys
    ...
    properties
        ...
        %
        fTemperatureInit = 293.15;
        
        %
        fPressureInit = 101325;
    end
    ...
    methods
        function this = Tutorial_Greenhouse(oParent, sName)
            ...
            this.oPlantModule = modules.PlantModuleIMPROVED(this, 'PlantModule', 1, 1);
        end
        ...
        function createMatterStructure(this)
            ...
            oAir = matter.phases.gas(...
                this.toStores.GreenhouseUnit , ...    	% Phase name
            ...
            aoPhases(1,1).fFixedTS = this.fGlobalTS;
            % Inedible biomass phase
            aoPhases = this.toStores.WasteStore.aoPhases;
            aoPhases(1,1).fFixedTS = this.fGlobalTS;
