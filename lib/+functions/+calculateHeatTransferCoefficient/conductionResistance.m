...
%
%for a round pipe
%fResist_Cond = calculateConductionResistance(fThermal_Cond_solid, fConfig,...
%               fRadius_in, fRadius_out, fLength) 
%
%for a plate
%fResist_Cond = calculateConductionResistance(fThermal_Cond_solid, 2,...
%               fArea, fThickness) 

function [fResist_Cond] = calculateConductionResistance(fThermal_Cond_solid,...
