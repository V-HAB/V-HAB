classdef Absorber_O2 < matter.procs.p2ps.flow
    ...
    methods
        function this = Absorber_O2(oStore, sName, sPhaseIn, sPhaseOut, sSubstance, fHarvest)
        ...
        function update(this)
            ...
            this.rLoad = 0;% this.oOut.oPhase.afMass(iSpecies) / this.fCapacity;
