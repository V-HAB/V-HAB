classdef water_absorber_waste < matter.procs.p2ps.flow
    ...
    methods
        function this = water_absorber_waste(oStore, sName, sPhaseIn, sPhaseOut, sSpecies)
            ...
            % is extracted.
            this.arExtractPartials(this.oMT.tiN2I.(this.sSpecies)) = 1;
        end
