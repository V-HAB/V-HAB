...
% supply humans with food and receive food
    ...
    methods
        ...
        function requestFood = registerHuman(this, sPort)
            ...
            components.P2Ps.ManualP2P(this.oParent, this, ['FoodPrepP2P_', num2str(this.iHumans)], ['Food.FoodPrepOut_', num2str(this.iHumans)], ['Food_Output_', num2str(this.iHumans), '.FoodPrepIn_', num2str(this.iHumans)]);
