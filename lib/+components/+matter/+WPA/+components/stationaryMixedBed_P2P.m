classdef stationaryMixedBed_P2P < matter.procs.p2ps.stationary & components.matter.WPA.components.baseMixedBed_P2P
    
    properties
    end
    
    methods
        function [this] = stationaryMixedBed_P2P(oStore, sName, sPhaseIn, sPhaseOut, oDesorptionP2P)
