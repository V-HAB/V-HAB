classdef flowWeakBaseAnion_P2P < matter.procs.p2ps.flow & components.matter.WPA.components.baseWeakBaseAnion_P2P
    
    properties
    end
    
    methods
        function [this] = flowWeakBaseAnion_P2P(oStore, sName, sPhaseIn, sPhaseOut, oDesorptionP2P)
