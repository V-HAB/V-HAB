classdef stationaryWeakBaseAnion_P2P < matter.procs.p2ps.stationary & components.matter.WPA.components.baseWeakBaseAnion_P2P
    
    properties
    end
    
    methods
        function [this] = stationaryWeakBaseAnion_P2P(oStore, sName, sPhaseIn, sPhaseOut, oDesorptionP2P)
            this@matter.procs.p2ps.stationary(oStore, sName, sPhaseIn, sPhaseOut);  
            this@components.matter.WPA.components.baseWeakBaseAnion_P2P(oStore, oDesorptionP2P);  
        end
    end
