classdef OGA < vsys
    ...
    methods
        ...
        function createMatterStructure(this)
            ...
            components.matter.P2Ps.ManualP2P(this, this.toStores.Electrolyzer, 'O2Proc', 'PhaseInLiquid.Port_O2_Out', 'O2Phase.Port_O2_In');
            
            %p2p proc to move the H2 to the gas phase
            components.matter.P2Ps.ManualP2P(this, this.toStores.Electrolyzer, 'GLS_proc', 'PhaseInLiquid.Port_H2_Out', 'H2Phase.Port_H2_In');
