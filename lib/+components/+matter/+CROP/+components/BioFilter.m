classdef BioFilter < matter.store
    ...
    methods
        function this = BioFilter(oContainer, sName, ...
                fMass_CH4N2O_Inital_Tank, fMass_NH3_Inital_Tank,fMass_NH4OH_Inital_Tank, ...
            ...
            oFlow  =  matter.phases.mixture(this, 'FlowPhase','liquid',...
                ...
                'CH4N2O', fMass_CH4N2O_Inital_Tank/rVolume_Ratio_TankSolution_FlowPhase,...
            ...
            oBio = matter.phases.mixture(this, 'BioPhase','liquid', ...
                struct('H2O', 0.1, 'CH4N2O', 1e-4, 'NH3', 1e-4, 'HNO2', 1e-4, ...
