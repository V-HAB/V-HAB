...
%   none
    ...
    methods
        function this = SEAR(oParent, sName, tParameters)
            ...
            components.matter.SEAR.subsystems.LCARSystem(this, 'LCARSystem', tParameters);
        ...
        function createMatterStructure(this)
            ...
            components.matter.SEAR.special.const_temp_press_exme(oVapor, 'Out', 2300, 293.15);
            ...
            components.matter.SEAR.special.const_temp_press_exme(oValvePhase, 'Out_1', 2300, 293.15);
            components.matter.SEAR.special.const_temp_press_exme(oValvePhase, 'Out_2', 2300, 293.15);
