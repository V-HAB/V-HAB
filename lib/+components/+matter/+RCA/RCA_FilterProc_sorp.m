classdef RCA_FilterProc_sorp < components.matter.filter.FilterProc_sorp_old
...
%   switch
    ...
    methods
        ...
        function [this] = RCA_FilterProc_sorp(oParentSys, oStore, sName, sPhaseIn, sPhaseOut, sType)
            this@components.matter.filter.FilterProc_sorp_old(oStore, sName, sPhaseIn, sPhaseOut, sType);   
    ...
    methods (Access = protected)
        function update(this)
            ...
            update@components.matter.filter.FilterProc_sorp_old(this)
