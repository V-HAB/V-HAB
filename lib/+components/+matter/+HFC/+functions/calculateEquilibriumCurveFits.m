function oEquilibriumCurveFits = calculateEquilibriumCurveFits(fTypeIL)
...
for ii = 1:length(afTemperatureData)
    ...
    %         afEqSolubilityTemp{iTemp} = afEqSolubilityTemp{iTemp}./(1+afEqSolubilityTemp{iTemp});
        ...
        afFitCoefficients(iTemp,1) = oFit{iTemp}.a(1,1);
        afFitCoefficients(iTemp,2) = oFit{iTemp}.b(1,1);
    end
end

oEquilibriumCurveFits = struct('afFitCoefficients',afFitCoefficients,'afTemperatureData',afTemperatureData);
