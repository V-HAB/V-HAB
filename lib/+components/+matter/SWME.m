classdef SWME < vsys
    ...
    methods
        ...
        function createMatterStructure(this)
            ...
            components.matter.SWME.stores.SWMEStore(this, 'SWMEStore', this.fSWMEVolume, this.fSWMEVaporVolume, this.fInitialTemperature);
            ...
            oProc = components.matter.SWME.procs.TemperatureProcessor(this, 'TemperatureProcessor');
