...
%   none
    ...
    methods
        function this = LCARAbsorber(oContainer, sName, tParameters)
            ...
            oFlow = components.matter.SEAR.phases.FlowPhase(this,...
                                        'Vapor',...
                                        struct('H2O', 1.26e-5),...
                                        1,...
            ...
            oAbsorberPhase = components.matter.SEAR.phases.AbsorbentPhase(this,...
                                        'AbsorberPhase',... Name
            ...
            this.oProc = components.matter.SEAR.processors.PhysicalAbsorber(this, 'absorberproc','Vapor.absorberport', 'AbsorberPhase.absorberport','H2O');
