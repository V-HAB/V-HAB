classdef Set_Plants_CO2GasExchange < matter.procs.p2ps.flow
    % Short description:
    %  This p2p-processor conducts the CO2 gas exchange between the
    ...
    methods
        function this = Set_Plants_CO2GasExchange(oStore, sName, sPhaseIn, sPhaseOut, sSubstance)
