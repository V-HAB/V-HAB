classdef Set_Plants_H2OGasExchange < matter.procs.p2ps.flow
    % Short description:
    ...
    methods
        function this = Set_Plants_H2OGasExchange(oStore, sName, sPhaseIn, sPhaseOut, oParent)
        ...
        function update(this)
            ...
            fFlowRate = this.oParent.oCreateBiomass.fH2OExchange;
